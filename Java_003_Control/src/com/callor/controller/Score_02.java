...
public class Score_02 {
	...
	public static void main(String[] args) {
		...
		//int, Integer 선언된 변수에는
		//-2의 31승 ~ 2의 31승 -1 까지의 값만 저장할 수 있다.
		intNum = 100_000_000_0; 
		
		//long, Long으로 선언된 변수에는 
		//-2의 63승 ~ 2의 63승 -1 까지의 값만 저장할 수 있다.
		...
		//오류를 막기위해서 숫자끝에(F,f)를 첨가한다.
		floatNum1 = 100.0f;
		
		//intNum1에 저장된 정수를 실수형으로 
		//변환하여 오차를 무시하고 저장하라
		floatNum1 = intNum1;
		
		//실수값(float)을 정수형변수에 저장하라 
		//라고 명령을 내리면 자바 컴파일러는
		 ...
		 * 소수점 이하 값이 필요없어서 정수형 변수에 저장하고 싶다.
		 ...
		 * 정수값.0 형식으로 실수로 "자동으로 변환"하고 저장한다.
		 ...
		 *인식하고, 오류를 보여준다.
		 *
		 * 만약 개발자(작성자)가 오차를 무시하고 강제로
		 * 실수값을 정수형에 변환하여 저장하고자 한다면
		 * "강제로 변환하는" 코드를 첨가하면 된다.(int)
		 * 실수값, 실수형변수에 저장된 값에서 
		 * 소수점이하 값을 무조건 잘라버리고
		 * 정수부분만 변수에 저장한다.
		 */
