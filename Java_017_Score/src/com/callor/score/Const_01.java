...
public class Const_01 {
	...
	public static void main(String[] args) {
		 ...
		 */
		List<String> strList1 = new ArrayList<String>(); // 데이터가 무작위로 추가됫다 삭제됫다 빠름
		List<String> strList2 = new LinkedList<>(); // 데이터가 순서대로 나열됫을때 빠름
		List<String> strList3 = new Vector<>(); // 게임에서 주로사용 위 다른것중 젤느림 
