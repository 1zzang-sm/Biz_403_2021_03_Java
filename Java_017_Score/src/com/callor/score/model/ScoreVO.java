 ...
 * 	모델링 된 Entity를 data TABLE로 생성하여 사용한다.
...
public class ScoreVO {
	...
	// VO클래스에 숫자형 변수를 선언할때 
	// primitve형이 아닌 wrapper 클래스 형으로 선언할때는 0으로 clear해주자
	 ...
	 * 
	 * 하지만 외부에서는 실제 코드가 작동되는지 몰라도 또는 관심갖지 않아도 상관없이 
	 * getTotal() method 는 당연히 잘계산된 총점 결과를 알려준다는 것을 알고 있다.
	 * 
	 ...
	 * 이게 vo객체.toString() method를 호출하면 vo객체의 변수들에 담긴 값들이 출력될 것이다.
	 * 
	 */
	@Override
