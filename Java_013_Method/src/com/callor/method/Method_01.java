...
public class Method_01 {
	...
	public static void main(String[] args) {
		/*
		 * Random 클래스를 사용하여 rnd 객체를 선언하고 Random() 생성자 method를 호출하여 객체를 생성(초기화)하는 코드 객체를
		 * 선언만 하고 생성(초기화)을 하지 않고 객체.method()를 호출하면 NullPointerException이 발생한다
		 * 
		 ...
		 * Scanner() 생성자 method를 호출하여 scan객체를 생성(초기화)한다
		 * Scanner() 생성자는 객체를 생성할때
		 * 	System.in(키보드 입력 장치)을 연결할 수 있도록 
		 ...
		 */
		Integer int1 = 30; // new Integer() 사용 금지
		 ...
		 */
		if(int1 % 3 == 0) {
			System.out.println(int1 + "은 3의 배수다");
		}else {
