...
public class Number_02 {
	...
	public static void main(String[] args) {
		...
		float floatNum1 = Float.parseFloat(strNum2);
		 ...
		 * 숫자, 문자, 특수기호 등을 모두 문자열(ASCII 코드)로 전송하고
		 * 	받는 곳에서 사용하기 전에 적절한 type으로 변경하여 사용한다.
		 * 
		 * Java에서는 WrapperClass.parse*() method 나
		 * 	WrapperClass.ValueOf() method를 사용하여 
		 * 	문자열형 숫자를 숫자 값으로 변환시키는 것을 지원한다.
		 * 
		 * 이 과정에서 숫자값으로 변환할 수 없는 문자열이 
		 * 	섞여 있는 경우 NumberFormatException 발생할 수 있다.
		 */
		...
		intNum1 = Integer.valueOf(100 + " "); //r
		intNum1 = Integer.valueOf("100 "); //r  r = 같다
		intNum1 = Integer.valueOf(" 100");
		...
		// "" 은 null과 유사한 값이다.
		// Java에서는 "" 과 null을 완전히 같은 것으로 취급하지 않는다.
