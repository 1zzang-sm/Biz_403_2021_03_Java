...
// com.callor.method.Method_01 ~ _02
...
public class NumberServiceV1A {
	...
	public Integer inputNum() {
		...
		if(num2 % 3 == 0) {
			...
			/*
			 * 현재 inputNum() method return type은 Integer이다.
			 * 그런데 여기에서 return하는 num2 변수 type은 int형이다.
			 * 별다른 문제를 일으키거나 하지는 않지만 실제 코드가 작동될때는
			 * int형을 Integer wrapper class형으로 변환하는 과정이 일어난다. 
			 */
			return num2;
		}
		return null;
