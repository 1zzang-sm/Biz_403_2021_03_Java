...
public class Varriable_10 {
	...
	public static void main(String[] args) {
		 ...
		 * 누적연산
		 */
		intSum += ++intNum; // 0 + 1 intSum save
		intSum += ++intNum; // 1 + 2 intSum save
		intSum += ++intNum; // 3 + 3 intSum save
		intSum += ++intNum; // 6 + 4 intSum save
		intSum += ++intNum; // 10 + 5 intSum save
		 ...
		 * intNum를 1 증가시켜라
		 */
		intSum += intNum++; // intSum을 출력하고 1을 증가 == 2
		intSum += intNum++; // 1 + 2
