 ...
 * 			클래스를 상속받게 하겠다. 라는 전제하에 상속을 받은 클래스에서는 자유롭게 접근 가능하다
 * 	부모클래스와 상속받은 자식클래스 간의 공유하는 목적
 */
public class ScoreServiceV1 {
	/*
	 * 맴버변수를 protected로 선언을 해 두면 
	 * 현재클래스(V1)를 상속받은 자식클래스에서 변수가 선언된 것처럼 동작할 수 있다.
	 * 
	...
	public void printScore() {
		...
		for(int i = 0; i < scoreList.size(); i++) {
			// scoreList의 i번째 저장된 값을 읽어서 scoreVO 형 sVO 객체에 담기
