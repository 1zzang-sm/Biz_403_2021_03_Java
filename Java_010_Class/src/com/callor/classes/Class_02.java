...
public class Class_02 {
	...
	public static void main(String[] args) {
		 ...
		 *  	primitive형은 포함할 수 없다.(int,float...)
		 *  	반드시 wrapper class 형만 포함할 수 있다.(Integer,Float...)
		 *  
		 *  List 형 객체 : List클래스를 사용한 객체
		 *  	선언할때는 List를 사용하고 생성(초기화)할때는 ArrayList() 생성자를 사용한다.
		 *  
		...
		//List형 객체에는 데이터를 저장할때는 <추가>를 하여 저장
		// List형 객체에 데이터를 추가할때는 .add() method를 사용하여 데이터를 추가한다.
		...
		* 위에서 add() 3번 실행했기 때문에 size는 3이되고 
