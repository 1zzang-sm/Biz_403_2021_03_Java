...
public class ScoreEx_03 {
	...
	public static void main(String[] args) {
		...
		// 	맴버변수의 값이 원치않게 변경되는 것을 방지
		
		//   private으로 선언된 total맴버변수는 연결연산자를 통해 total 맴버변수에 값을 직접 저장할 수 없다.
		//   홍길동.total = 900;
		
		//getter method
		//get으로 시작되는 method는 private으로 선언된 맴버변수의 값을 읽을때 사용하는 method선언 접두사 다.
