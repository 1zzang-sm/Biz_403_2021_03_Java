...
public class App_05 {
	public static void main(String[] args) {
		...
		/*
		 * ssV5.makeScores() 명령이 실행되면 Score...V5 클래스의 makeScores() method의 코드가 실행된다.
		 * 코드가 모두 정상 종료되거나 아니면 중간에 return명령문을 만나면(중단)
		...
		// static method
		//	method에 static keyword가 부착되면 객체를 생성하는 절차 없이 method를 직접 호출할 수 있다.
		//	클래스.method()
