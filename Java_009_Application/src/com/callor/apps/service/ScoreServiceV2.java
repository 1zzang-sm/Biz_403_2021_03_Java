...
public class ScoreServiceV2 {
	...
	/*
	 * this(현재객체, 현재클래스)
	 * 같은 클래스 내에 있는 코드 this. 
	 */
	public void makeScores() {
		System.out.println("국어점수입력");
		// method return type이 void가 아닌경우에는 method가 return한 값을 변수에 저장(받기)할 수 있다.
		// 이때 변수는 method return과 같은 type(형)이어야 한다.
	...
	private Integer inputScore() {
		...
		// score변수에 저장된 값을 호출한 곳으로 되돌려 주어라
		return score;
