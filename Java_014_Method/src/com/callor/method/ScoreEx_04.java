...
//stack 변수 저장공간 heap 클래스의 실제데이터 저장공간
...
public class ScoreEx_04 {
	...
	public static void main(String[] args) {
		...
		// Heap 메모리에 kr,eng,math.. 등의 값을 저장할 저장소를 만들고
		// 저장소들의 첫번째 주소를 stack 메모리에 저장하고 그곳에 scoreVO라는 이름을 붙여라
		...
		/*
		 * scoreVO 객체의 kor 변수의 값을 읽어서 intKor의 변수에 저장해 달라
