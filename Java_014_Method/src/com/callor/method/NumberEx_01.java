...
public class NumberEx_01 {
	...
	public static void main(String[] args) {
		...
		//정수31과 29를 전달하고 그 결과를 retNum변수에 저장해라
		Integer retNum = nsV1.addNum(2534, 1326);
		if(retNum == null) {
			System.out.println("결과는 짝수아님");
		}else {
		 ...
		 * 		return type 이 Float 이기 때문에
		 * 		return 되는 결과값을 저장하는 변수(retNum1)도
		 * 		반드시 float, Float형 이어야 한다.
		 */
		// Integer retNum1 = nsV1.addNum(32.2f, 33.2f);
		 ...
		 * 
		 * 특히 숫자를 다루는 경우에 항상 숫자 값만 저장된다는 
		 * 보장이 있을 경우 primitive방식으로 선언해도 아무런 문제가 없다
		 * 
		...
		// public Float addNum(int num1, int num2)
		nsV1.addNum(30, 40);
