 ...
 * JDK에 있는 도구들을 사용하여 프로젝트를 만들 수 있다.
 * JDK에 있는 도구는 워낙 종류, 개수가 많아서 
 * 한꺼번에 프로젝트에 포함하면 프로젝트가 너무 거대해 질 것이다.
 * 이러한 문제를 방지하기 위하여 Java에서는 가장 기본적인 도구 외에는
 * 모두 파일로 제공하고 필요에따라 import하여 사용할 수 있도록 하고있다.
 * import java.util.Random;
 * 지금부터 Controller_06 class 에서 java.utill package의 Random class 라는 
...
public class Controller_06 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * class 키워드처럼 사용이 되지만 java가 탄생하고 이후에 
		 * 필요에따라 추가, 확장된 명령 
		 */
		 ...
		 *  확장된 기능을 할 수 있도록 만들어진 class이다.
		 *  
		 *  기본기능은 값을 저장하는 변수를 선언한다.
		 *  기본기능에 별도로 확장된 추가 명령을 수행할 수 있도록
		 *  만들어진 도구들이다.
		 */
